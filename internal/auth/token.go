...
func NewAccessTokenProviderFromStore(configStore *ConfigStore, configKey string) (TokenProvider, error) {
...
func NewLoginTokenProviderFromStore(configStore *ConfigStore, configKey, baseURL string) (TokenProvider, error) {
	...
	if username == "" || password == "" {
		return nil, fmt.Errorf("empty credentials found in store")
	}
