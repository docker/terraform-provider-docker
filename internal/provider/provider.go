...
`,
		Attributes: map[string]schema.Attribute{
			...
			"username": schema.StringAttribute{
				MarkdownDescription: "Username or organization namespace for authentication",
				Optional:            true,
			},
			"password": schema.StringAttribute{
				MarkdownDescription: "Password, PAT, or OAT for authentication",
				Optional:            true,
				Sensitive:           true,
			},
...
func (p *DockerProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewOrgSettingImageAccessAllowlistResource,
		NewOrgSettingRegistryResource,
		NewOrgSettingRegistryAccessManagementResource,
		NewOrgTeamResource,
		NewOrgTeamMemberResource,
		NewRepositoryResource,
		NewRepositoryImmutableTagsResource,
